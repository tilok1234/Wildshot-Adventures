...
## 3 since sl-0116: the bag op joined the recorded frame
## (SERIALIZED_SIZE 16 -> 17; 2 was sl-0112's interact era). Old
## versions refuse loudly — history is never silently reinterpreted.
const VERSION := 3
